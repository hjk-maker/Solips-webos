...
class AICore {
  constructor(){
    this.providers = {
      ollama:    { name:'Ollama (Local)',    endpoint:'http://localhost:11434', chat:'/v1/chat/completions', models:'/api/tags', type:'ollama', model:'llama3.2' },
      ...
      anthropic: { name:'Anthropic', endpoint:'https://api.anthropic.com', chat:'/v1/models', models:null, type:'anthropic', model:'claude-sonnet-4-5', key:'' },
      ...
      grok :      { name:'Grok',    endpoint:'https://api.x.ai/', chat:'/v1/chat/completions', models:'/v1/models', type:'openai', model:'grok-4.5', key:'' }
    };
    this.active = null;
    this.history = [];
    this._load();
