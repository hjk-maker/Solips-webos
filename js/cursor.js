/* ── VIRTUAL CURSOR + KEYBOARD ──
   Gives the AI a way to actually act inside Solips-webos: move a visible cursor,
   click whatever is under it, and type into whatever's focused.

   Important scope limits, stated plainly:
   - This cursor only exists inside the Solips-webos page. It cannot move the
     visitor's real OS mouse, and it cannot reach into other browser tabs.
   - It CAN click and type inside Solips-webos's own windows (Terminal, Files,
